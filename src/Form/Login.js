                ...
                <div className="flex w-full max-w-5xl overflow-hidden rounded-3xl shadow-2xl">
                    ...
                    <div className="w-full md:w-1/2 bg-white/10 backdrop-blur-md p-8 sm:p-10">
                        ...
                        <form onSubmit={handleSubmit} className="space-y-5">
                            <div
                                className={`group flex items-center rounded-xl bg-white px-4 py-3 shadow-md transition-all duration-300 ${focusedField === "username"
                                    ? "ring-2 ring-blue-500 shadow-blue-200/50"
                                    : "hover:shadow-lg"
                                    }`}
                            >
                                <div
                                    className={`mr-3 flex h-10 w-10 items-center justify-center rounded-full transition-all duration-300 ${focusedField === "username"
                                ...
                                >
                                    <User
                                        size={20}
                                        className={`transition-all duration-300 ${focusedField === "username"
                            ...
                            {/* Password */}
                            <div
                                className={`group flex items-center rounded-xl bg-white px-4 py-3 shadow-md transition-all duration-300 ${focusedField === "password"
                                    ? "ring-2 ring-blue-500 shadow-blue-200/50"
                                    : "hover:shadow-lg"
                                    }`}
                            >
